// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Limit.cs" company="Sundews">
...
public readonly struct Limit
{
    ...
    {
        return new Limit(true, limitIndicator);
    }
    ...
    {
        return new Limit(false, limitIndicator);
    }
    ...
    {
        return new Limit(isLeft, limitIndicator);
    }
    ...
    {
        return new Limit(isLeft, ThreeDots);
    }
    ...
    {
        return new Limit(isLeft, Epsilon);
    }
}