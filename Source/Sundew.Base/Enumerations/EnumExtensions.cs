// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EnumExtensions.cs" company="Hukano">
// Copyright (c) Hukano. All rights reserved.
// Licensed under the MIT license. See LICENSE file in the project root for full license information.
// </copyright>
// --------------------------------------------------------------------------------------------------------------------

namespace Sundew.Base.Enumerations
{
    using System;
    ...
    public static class EnumExtensions
    {
        ...
        public static TEnum ParseFlagsEnum<TEnum>(
            ...
            where TEnum : Enum
        {
            return value.ParseFlagsEnum<TEnum>(CultureInfo.CurrentCulture, separator, ignoreCase, removeWhiteSpace);
        }
        ...
        public static TEnum ParseFlagsEnum<TEnum>(
            ...
            where TEnum : Enum
        {
            TryParseFlagsEnum(value, cultureInfo, out TEnum result, true, separator, ignoreCase, removeWhiteSpace);
            return result;
        }
        ...
        public static bool TryParseFlagsEnum<TEnum>(
            ...
            where TEnum : Enum
        {
            return value.TryParseFlagsEnum(CultureInfo.CurrentCulture, out result, separator, ignoreCase, removeWhiteSpace);
        }
        ...
        public static bool TryParseFlagsEnum<TEnum>(
            ...
            where TEnum : Enum
        {
            return TryParseFlagsEnum(value, cultureInfo, out result, false, separator, ignoreCase, removeWhiteSpace);
        }
            ...
            where TEnum : Enum
        {
            ...
            foreach (var enumName in enumNames)
            {
                if (throwOnError)
                {
                    enumValue |= Convert.ToUInt64(enumName.ParseEnum<TEnum>(ignoreCase), cultureInfo);
                }
                else
                {
                    if (enumName.TryParseEnum(out TEnum temporaryEnum, ignoreCase))
                    {
