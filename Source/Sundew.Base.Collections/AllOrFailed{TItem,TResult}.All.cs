// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AllOrFailed{TItem,TResult}.All.cs" company="Sundews">
...
public sealed class All<TItem, TResult> : AllOrFailed<TItem, TResult>, IReadOnlyList<TResult>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="All{TItem, TResult}" /> class.
    /// </summary>
