...
public static class Option
{
    ...
    /// <returns>
    /// The value if defined, otherwise the result of the alternative function.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TValue? Or<TValue>(this TValue? value, Func<TValue?> alternativeFunc)
        where TValue : class
    {
        return value ?? alternativeFunc();
    }
    ...
    /// <returns>The value if present, otherwise the specified default value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TNewValue Evaluate<TValue, TNewValue>(this TValue? value, Func<TValue, TNewValue> newValueFunc, Func<TNewValue> alternativeValueFunc)
        where TValue : class
    {
        return value != null ? newValueFunc(value) : alternativeValueFunc();
    }
    ...
    /// <returns>The value if present, otherwise the specified default value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TNewValue Evaluate<TValue, TParameter, TNewValue>(this TValue? value, TParameter parameter, Func<TValue, TParameter, TNewValue> newValueFunc, Func<TParameter, TNewValue> alternativeValueFunc)
        where TValue : class
    {
    ...
    /// <returns>The value if present, otherwise the specified default value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TNewValue Evaluate<TValue, TParameter1, TParameter2, TNewValue>(this TValue? value, TParameter1 parameter1, TParameter2 parameter2, Func<TValue, TParameter1, TParameter2, TNewValue> newValueFunc, Func<TParameter1, TParameter2, TNewValue> alternativeValueFunc)
        where TValue : class
    {
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TNewValue? CombineToValue<TValue, TOtherValue, TNewValue>(this TValue? value, TOtherValue? otherValue, Func<TValue, TOtherValue, TNewValue> getValueFunc)
        where TValue : class
        ...
        where TValue : struct
    {
        ...
        return new R<TValue, TError>(isSuccess, value.GetValueOrDefault(), isSuccess ? default! : error);
    }
    ...
    {
        var isSuccess = value.HasValue;
        return new R<TValue, TError>(isSuccess, value.GetValueOrDefault(), isSuccess ? default! : errorFunc());
    }
    ...
    {
        var isSuccess = value.HasValue;
        return new R<TNewValue, TError>(isSuccess, isSuccess ? valueFunc(value.GetValueOrDefault()) : default!, error);
    }
    ...
    public static TValue? ToOptionalValue<TValue>(this bool option, TValue optionalValue)
        where TValue : struct
    {
    ...
    /// <returns>An optional value.</returns>
    public static TValue? ToOptionalValue<TValue>(this bool option, Func<TValue> optionalValueFunc)
        where TValue : struct
    {
    ...
    /// <param name="optionalValueFunc">The optional value func.</param>
    /// <returns>An optional value.</returns>
    public static TValue? From<TValue>(this bool option, Func<TValue> optionalValueFunc)
        where TValue : class
    {
        return option ? optionalValueFunc() : default;
    }
