...
namespace Sundew.Base.Enumerations
{
    ...
    public static class EnumExtensions
    {
        ...
        public static TEnum ParseFlagsEnum<TEnum>(
            ...
            where TEnum : Enum
        {
            TryParseFlagsEnum(value, cultureInfo, out TEnum result, true, separator, ignoreCase);
            return result;
        }
        ...
        public static bool TryParseFlagsEnum<TEnum>(
            ...
            where TEnum : Enum
        {
            return TryParseFlagsEnum(value, cultureInfo, out result, false, separator, ignoreCase);
        }
